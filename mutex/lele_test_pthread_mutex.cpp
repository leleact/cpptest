...
void *func2(void *arg) {
  ...
  std::cout << "prepare operat g_stSource1" << std::endl;
  g_stSource1.nSource = g_stSource1.nSource + 1;
  std::cout << "operat g_stSource1 finished" << std::endl;
